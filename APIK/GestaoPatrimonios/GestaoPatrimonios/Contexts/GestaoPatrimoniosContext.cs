...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AreaID).HasName("PK__Area__70B82028ACEAB32F");

            entity.HasIndex(e => e.NomeArea, "UQ__Area__9A7797600FDA0C48").IsUnique();
        ...
        {
            entity.HasKey(e => e.BairroID).HasName("PK__Bairro__4A09362397C15CD2");
        ...
        {
            entity.HasKey(e => e.CargoID).HasName("PK__Cargo__B4E665EDACD6DDB8");

            entity.HasIndex(e => e.NomeCargo, "UQ__Cargo__4D9FD7DE2B459474").IsUnique();
        ...
        {
            entity.HasKey(e => e.CidadeID).HasName("PK__Cidade__B68009591DBAB704");
        ...
        {
            entity.HasKey(e => e.EnderecoID).HasName("PK__Endereco__B9D9462FDD7C8273");
        ...
        {
            entity.HasKey(e => e.LocalizacaoID).HasName("PK__Localiza__83ABDECAD20221AF");
        ...
        {
            entity.HasKey(e => e.LogPatrimonioID).HasName("PK__LogPatri__E716D12B9AFCBBC4");
        ...
        {
            entity.HasKey(e => e.PatrimonioID).HasName("PK__Patrimon__C5A60BDE2612F064");

            entity.ToTable(tb => tb.HasTrigger("trg_Patrimonio_SoftDelete"));

            entity.HasIndex(e => e.NumeroPatrimonio, "UQ__Patrimon__3BC8B35DFA759EDE").IsUnique();
        ...
        {
            entity.HasKey(e => e.TransferenciaID).HasName("PK__Solicita__E5B4F5F2A1679B6A");
        ...
        {
            entity.HasKey(e => e.StatusPatrimonioID).HasName("PK__StatusPa__B3F33609C3FF366B");

            entity.HasIndex(e => e.NomeStatus, "UQ__StatusPa__C5C60F1ADAAE187F").IsUnique();
        ...
        {
            entity.HasKey(e => e.StatusTransferenciaID).HasName("PK__StatusTr__7AA828B9770EE49E");

            entity.HasIndex(e => e.NomeStatus, "UQ__StatusTr__C5C60F1AA12BD9BD").IsUnique();
        ...
        {
            entity.HasKey(e => e.TipoAlteracaoID).HasName("PK__TipoAlte__9BEF4F0D033D84AB");

            entity.HasIndex(e => e.NomeTipo, "UQ__TipoAlte__7859A10A0153B307").IsUnique();
        ...
        {
            entity.HasKey(e => e.TipoUsuarioID).HasName("PK__TipoUsua__7F22C7024EFF671D");

            entity.HasIndex(e => e.NomeTipo, "UQ__TipoUsua__7859A10A1B9B7A50").IsUnique();
        ...
        {
            entity.HasKey(e => e.UsuarioID).HasName("PK__Usuario__2B3DE7988D873989");

            entity.ToTable(tb => tb.HasTrigger("trg_Usuario_SoftDelete"));

            entity.HasIndex(e => e.RG, "UQ__Usuario__321537C824636A55").IsUnique();

            entity.HasIndex(e => e.CarteiraTrabalho, "UQ__Usuario__6E25BCA206B331FD").IsUnique();

            entity.HasIndex(e => e.Email, "UQ__Usuario__A9D10534E7BD0315").IsUnique();

            entity.HasIndex(e => e.CPF, "UQ__Usuario__C1F89731123AC570").IsUnique();

            entity.HasIndex(e => e.NIF, "UQ__Usuario__C7DEC33067BE7D6E").IsUnique();
