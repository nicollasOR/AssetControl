...
SELECT * FROM StatusTransferencia

INSERT INTO StatusPatrimonio(NomeStatusPatrimonio)
VALUES
    ('Ativo'),
    ('Inativo'),
    ('Transferido'),
...
INSERT INTO Endereco (Logradoura, Numero, Complemento, CEP, BairroId)
VALUES
    (
     'Taligado ne',
     133,
     'Se quiser sim mano',
     '09810-560',
     (SELECT BairroId FROM Bairro WHERE NomeBairro = 'Centro')
    )

GO

INSERT INTO Usuario(Nome, RG, CPF, CarteiraTrabalho, Email, Senha, NIF, EnderecoId, CargoId, TipoUsuarioId)
VALUES
(
    'adm',
 '12345677',
 ...
 '123',
 (SELECT EnderecoId FROM Endereco WHERE Numero = 133),
 (SELECT CargoId FROM Cargo WHERE Nome = 'Diretor'),
 (SELECT TipoUsuarioId FROM TipoUsuario WHERE TipoUsuario.Nome = 'Coordenador')
