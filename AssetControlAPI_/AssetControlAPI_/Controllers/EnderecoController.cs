...
namespace AssetControlAPI_.Controllers
{
    ...
    public class EnderecoController : ControllerBase
    {
        ...
        [HttpGet("busca/")]
        public ActionResult<LerEnderecoDTO> BuscarPorLogradouroENumero(string logradouro, int? numero, Guid bairroId, Guid? enderecoId)
        {
            try
            {
                LerEnderecoDTO lerDTO = _service.BuscarPorLogradouroENumero(logradouro, numero, bairroId, enderecoId);
                return Ok(lerDTO);
            }
