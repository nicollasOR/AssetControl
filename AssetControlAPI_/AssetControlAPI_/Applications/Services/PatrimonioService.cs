...
namespace AssetControlAPI_.Applications.Services
{
    public class PatrimonioService
    {
        ...
        //{
        //                    //analisar  //Patrimonio patrimonio = _repository.BuscarPorNumeroPatrimonio(numeroPatrimonio, patrimonioId);
        //    bool patrimonioExistente = _repository.BuscarPorNumeroPatrimonio(criarDTO.NumeroSerie);
        ...
        public void Adicionar(ListarPatrimonioDTO criarDTO)
        {
            ...
            if (patrimonioExistente != null)
                throw new DomainException("Já existe um patrimonio com este numero");
        ...
        public void AtualizarStatus(Guid guid, AtualizarStatusPatrimonioDTO atualizarDTO)
        {
            Patrimonio? patrimonioBanco = _repository.BuscarPorId(guid);
            ...
            if (!_repository.StatusPatrimonioExiste(atualizarDTO.StatusPatrimonioId))
            {
                throw new DomainException("Status de patrimônio informado não existe.");
            }

            patrimonioBanco.StatusPatrimonioId = atualizarDTO.StatusPatrimonioId;
